...
/*			if(huge_video_playing['video_is_playing_'+<?php echo $sliderID; ?>] && !clicked){
     ...
     function huge_it_popup_resize_<?php echo $sliderID; ?>() {
		...
		var str=<?php echo $sliderheight;?>/(staticsliderwidth-2*<?php echo $sliderBorderWidth;?>); // alert(str);
                var str2 = <?php echo $paramssld['slider_thumb_height']; ?>/<?php echo $sliderwidth;?>;
                var sliderDynamicImageHeight = sliderwidth*str-2*<?php echo $sliderBorderWidth;?>;
                <?php if($slider[0]->show_thumb == 'thumbnails') {?>
                    var sliderDynamicThumbHeight = sliderwidth*str2+<?php echo $sliderBorderWidth;?>;
                ...
                jQuery('.huge_it_slideshow_thumbs_<?php echo $sliderID; ?> li').css({'max-height':sliderDynamicThumbHeight-<?php echo $sliderBorderWidth;?>});
      ...
      <div id="huge_it_slideshow_image_container_<?php echo $sliderID; ?>" class="huge_it_slideshow_image_container_<?php echo $sliderID; ?>">        
        <div class="huge_it_slide_container_<?php echo $sliderID; ?>">
          <div class="huge_it_slide_bg_<?php echo $sliderID; ?>">
            <ul class="huge_it_slider_<?php echo $sliderID; ?> huge_it_slider_ul">
			  <?php
			  $i=0;
