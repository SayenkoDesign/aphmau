	  ...
	  .huge_it_slideshow_title_text_<?php echo $sliderID; ?> {
		...
		<?php   
			...
			elseif($slideshow_title_position[1]=="bottom"){echo 'bottom:'.$slider_title_margin.'%;';}
                        if($slideshow_title_position[0] && $slideshow_title_position[1]=="middle") {echo "transform:translate(-50%, -50%);"; }
		 ?>
		padding:2%;
	  ...
	  .huge_it_slideshow_description_text_<?php echo $sliderID; ?> {
		...
		<?php 
			...
			elseif($slideshow_description_position[1]=="bottom"){echo 'bottom:'.$slider_description_margin.'%;';}
                        if($slideshow_description_position[0] && $slideshow_description_position[1]=="middle") {echo "transform:translate(-50%, -50%);"; }
		 ?>
		padding:3%;
	  ...
	  .huge_it_slideshow_dots_deactive_<?php echo $sliderID; ?> {
		...
		.huge_it_slideshow_image_wrap_<?php echo $sliderID; ?> {
			background:#<?php echo $paramssld['slider_slider_background_color']; ?>;
                        border:<?php echo $paramssld['slider_slideshow_border_size']; ?>px #<?php echo $paramssld['slider_slideshow_border_color']; ?> solid; 
                        border-radius:<?php echo $paramssld['slider_slideshow_border_radius']; ?>px;
                        box-sizing: content-box;
                        <?php if($paramssld['slider_navigation_type'] != 16) echo 'overflow: hidden;';?>
...
if(isset($GLOBALS['thumbnail_width'])){
	$width_huge=$GLOBALS['thumbnail_width']-2*$paramssld['slider_slideshow_border_size'];
}else{
	$width_huge='';
}
?>
		...
		.huge_it_slideshow_thumbs_container_<?php echo $sliderID; ?>{
			...
			display: none;
			<?php }?>
                    border-top:<?php echo $paramssld['slider_slideshow_border_size']; ?>px #<?php echo $paramssld['slider_slideshow_border_color']; ?> solid; 
		}
                .huge_it_slideshow_image_wrap_<?php echo $sliderID; ?> .huge_it_slideshow_thumbs_container_<?php echo $sliderID; ?> ul {
                    margin: 0;
                }
...
<?php
		...
		switch ($paramssld['slider_navigation_type']) {
			...
			case 16:
				?>
					#huge_it_slideshow_left_<?php echo $sliderID; ?> {	
						left:-<?php echo 21*$arrowValue+$sliderBorderWidth-1;?>px;
					...
					#huge_it_slideshow_right_<?php echo $sliderID; ?> {
						right:-<?php echo 21*$arrowValue+$sliderBorderWidth-1;?>px;
						margin-top:-<?php echo 20*$arrowValue;?>px;
						height:<?php echo 40*$arrowValue;?>px;
						width:<?php echo 37*$arrowValue;?>px;
						background:url(<?php echo $arrowfolder;?>/arrows.black.out.png) right top no-repeat; 
...
if($paramssld['slider_thumb_count_slides'] != 0){
