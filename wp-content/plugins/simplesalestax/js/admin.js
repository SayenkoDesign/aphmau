        ...
        jQuery.ajax({
            ...
            success: function(resp) {
                if (resp == 1) {
                    ...
                    alert('An error prevented Simple Sales Tax from disabling notifications. Please try again.');
                }
            }
        });
                    ...
                    if (resp != false && resp != null) {
                        if (resp.status == 'success') {
                            ...
                            if (resp.status == 'error') {
                                ...
                                alert('An error prevented Simple Sales Tax from verifying your business address(es). Please try again.');
                            }
                        }
                    } else {
                        alert('An error prevented Simple Sales Tax from verifying your business address(es). Please try again.');
