<?php
/**
 * Template for the "Add Certificate" form. You can override this template by copying it
 * to THEME_PATH/sst/lightbox/add-certificate.php.
 *
 * @package WooTax
...
// TODO: UPDATE OTHER TEMPLATE FILES TO FIT THIS FORMAT; REMOVE ROOT ELEMENTS FROM ALL TEMPLATE FILES; ENQUEUE LIGHTBOX JS / CSS ON CHECKOUT PAGE
?>
...
<body id="add-certificate">
  ...
  <form action="#" method="post">
    ...
    <div class="form-row">
      ...
      <button type="button" id="manageCertsButton" class="grey">Manage Certificates</button> 
