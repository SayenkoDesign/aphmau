...
class WCST_Option
{
	...
	public function save_general_options($options)
	{
		...
		{
			$old_estimated_shipping_label['estimated_shipping_info_product_page_label'][$wpml_helper->get_current_locale()] = isset($options['estimated_shipping_info_product_page_label'][$wpml_helper->get_current_locale()]) ? $options['estimated_shipping_info_product_page_label'][$wpml_helper->get_current_locale()] : "";
			$options['estimated_shipping_info_product_page_label'] = $old_estimated_shipping_label['estimated_shipping_info_product_page_label'];
		}
	...
	public function get_estimations_options($option_name = null, $default_value = null)
	{
		...
		$all_data = array();
		//$all_data['hour_offset'] = get_field('wcst_hour_offset', 'option'); //Number: -1440 / 1440, step size 1, default 0
		$all_data['hour_offset'] = get_option('gmt_offset') * 60; 
